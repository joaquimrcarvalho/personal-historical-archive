...
function resolveNoteName(target, names) {
...
function mergeDraft(existing, context) {
...
function parseNumberQuery(text) {
...
function scanRequestText(status) {

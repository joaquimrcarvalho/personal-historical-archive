...
loss — 0.19.0). Still to do: **notes search**, **page navigation for citations**,
the `extends` composition directive, the encoder structure prescan, and
**endpoint-scoped locking** (the last one is operational rather than a pipeline
feature, and can land any time).
